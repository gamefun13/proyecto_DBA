...
\section{Integración de Datos Territoriales y Filtro PDET}
...
\subsection{Metodología de procesamiento y normalización}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{images/mgn_shp_qgis.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\linewidth]{images/pdet_python_plot.jpeg}
...
\subsection{Validación geoespacial y control de calidad}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{images/capas_superpuestas.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\linewidth]{images/validacion_colores.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\linewidth]{images/validacion_lotes.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\linewidth]{images/validacion_individual.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{images/python_console.jpeg}
...
Esta transformación constituye una etapa crítica dentro del pipeline geoespacial, debido a que permite convertir estructuras territoriales tradicionales en objetos GeoJSON compatibles con MongoDB y operaciones espaciales NoSQL.\subsection{Modelo de Datos Inicial}
